...
/**
 * AlterCheckCommandPlugin provides alter-check goal to run manage.[sh|bat] alter-check.
 * 
 * @goal alter-check
 * 
 * @author shinsuke
 *
 */
public class AlterCheckCommandPlugin extends CommandPlugin {
