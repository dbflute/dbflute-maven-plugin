...
/**
 * TakeAssertCommandPlugin provides take-assert goal to run manage.[sh|bat] take-assert.
 * 
 * @goal take-assert
 * 
 * @author shinsuke
 *
 */
public class TakeAssertCommandPlugin extends CommandPlugin {
