...
/**
 * SavePreviousCommandPlugin provides save-previous goal to run manage.[sh|bat] save-previous.
 * 
 * @goal save-previous
 * 
 * @author shinsuke
 *
 */
public class SavePreviousCommandPlugin extends CommandPlugin {
